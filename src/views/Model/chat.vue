          ...
          <div class="aichat">
            <el-watermark :font="{color:'rgba(0, 0, 0, 0.001)'}" :gap="[0,0]" :rotate="-12"
              ...
              <div class="system mb-3 md:mb-4 lg:mb-5 block">
                ...
                <div class="text-sm text-slate-600 w-full text-center mt-4 lg:mt-8 opacity-80">免费服务器性能调度有限，回复略有延迟，如果是lingben-dragon回复问题那么就是无阉割版，其他模型均为阉割版，敬请见谅。请留给我们进步的空间</div>
