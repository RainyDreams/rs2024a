    ...
    <div class="panel bs-container py-6 md:py-12 lg:py-16 xl:py-22">
      <div class="row">
        <div class="col-12 col-md-6">
          <h1 class="mt-1 mb-3 text-4xl font-semibold md:mt-10 md:mb-8 md:text-6xl/snug lg:text-7xl/snug">零本创智</h1>
          <h3 class="text-lg/7 md:text-2xl/snug lg:text-3xl/snug text-slate-500">我们的愿景</h3>
          <h5 class="text-xl/7 md:text-3xl/snug lg:text-4xl/snug">依托尖端的 AI 技术驱动力量，构建全面创新的市场项目解决方案体系，致力于让「零成本构建创新高效应用程序」成为现实。</h5>
        </div>
        <div class="col-12 col-md-6">
    ...
    <div class="panel bs-container py-6 md:py-12 lg:py-16 xl:py-22">
      <div class="row">
        <div class="col-12">
          ...
          <p class="text-xl/7 md:text-3xl/snug lg:text-4xl/snug mb-3">项目发展至今仍零支出</p>
        </div>
          ...
          <div class="row">
            <div class="col-12 col-sm-6 col-md-4">
              <div class="card px-6 bg-white py-8 rounded-xl border-slate-200 border">
                <h3 class="font-semibold text-2xl/tight lg:text-3xl/tight text-colored">零成本</h3>
                <p class="text-base mt-3">我们采用无服务器的Workers，我们在有限的服务内无需支出任何成本当然也不会收取您费用</p>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              <div class="card px-6 bg-white py-8 rounded-xl border-slate-200 border">
                <h3 class="font-semibold text-2xl/tight lg:text-3xl/tight text-colored">高速响应</h3>
                <p class="text-base mt-3">我们不断地优化我们服务器代码和前端架构，这使得我们软件的平均响应速度&lt;1s</p>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              <div class="card px-6 bg-white py-8 rounded-xl border-slate-200 border">
                <h3 class="font-semibold text-2xl/tight lg:text-3xl/tight text-colored">界面美观</h3>
    ...
    <div class="panel bs-container py-6 md:py-12 lg:py-16 xl:py-22">
      <div class="row">
        <div class="col-12">
          ...
          <p class="text-xl/7 md:text-3xl/snug lg:text-4xl/snug">采用我们原创的 <span class="text-colored font-semibold text-2xl/tight md:text-4xl/tight lg:text-5xl/tight">3</span>token + <span class="text-colored font-semibold text-2xl md:text-4xl/tight lg:text-5xl/tight">1</span>鉴权  + <span class="text-colored font-semibold text-2xl md:text-4xl/tight lg:text-5xl/tight">N</span>验证 模式</p>
        </div>
        <div class="col-12"></div>
      </div>
    </div>
    <div class="panel bs-container py-6 md:py-12 lg:py-16 xl:py-22">
      <div class="row">
        <div class="col-12">
          ...
          <h5 class="text-xl/7 md:text-3xl/snug lg:text-4xl/snug">我们能迅速给出精准的解决方案，大大缩短项目周期，让您的业务降本增效</h5>
        </div>
        <div class="col-12"></div>
      </div>
    </div>
    <div class="panel bs-container py-6 md:py-12 lg:py-16 xl:py-22">
      <div class="row">
        <div class="col-12">
          ...
          <p class="text-xl/7 md:text-3xl/snug lg:text-4xl/snug">我们坚信创新是引领发展的第一动力</p>
          <p class="text-xl/7 md:text-3xl/snug lg:text-4xl/snug">致力于为您提供独特而前沿的项目解决方案</p>
        </div>
        <div class="col-12"></div>
      </div>
    </div>
    <div class="panel bs-container py-6 md:py-12 lg:py-16 xl:py-22">
      <h2 class="font-semibold mt-10 mb-10 text-3xl md:mt-20 md:mb-20 md:text-5xl/snug lg:text-6xl/snug text-center">梦想只是开始 探索永不止步</h2>
    </div>
    <div class="copyright py-5">
      <p class="text-center">赤子英金 · 零本创智</p>
      <p class="text-center text-sm mt-1 mb-1">- 赤子英金第一款成熟产品发布留念 -</p>
